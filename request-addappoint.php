            ...
            <div class="page-heading">
                ...
                <?php
                    ...
                    if (isset($_POST['submitinformation'])) {
                        ...
                        $query = "INSERT INTO 'notification' (`id`, `name`, `type`, `message`, `status`, `date`, `reserved_date`) VALUES (NULL, '$name', 'request-appointment', '$message', 'unread', '$2021-05-03 16:43:10', '2021-05-28 16:41:41')";
