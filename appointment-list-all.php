                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($user as $row) {
                                        ...
                                        /*
                                        $result2 = mysqli_query($conn, "SELECT appointwoo.start_appoint, orderwoo.cust_id 
                                        FROM appointwoo LEFT JOIN orderwoo ON orderwoo.order_id=appointwoo.order_id WHERE orderwoo.order_id=$orderid LIMIT 1");
