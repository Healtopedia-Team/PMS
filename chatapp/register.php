...
if (isset($_POST["register"])) {
    ...
    $user_object->setFirstName($_POST['first_name']);

    $user_object->setLastName($_POST['last_name']);
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" id="register_form">
                            <div class="form-group">
                                ...
                                <input type="text" name="username" id="firstname" class="form-control" data-parsley-pattern="/^[a-zA-Z\s]+$/" required />
                            </div>
                            <div class="form-group">
                                <label>Enter Your Last Name</label>
                                <input type="text" name="first_name" id="lastname" class="form-control" data-parsley-pattern="/^[a-zA-Z\s]+$/" required />
                            </div>
                            <div class="form-group">
                                <label>Enter Your Name</label>
                                <input type="text" name="last_name" id="username" class="form-control" data-parsley-pattern="/^[a-zA-Z\s]+$/" required />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" id="password" class="form-control" data-parsley-minlength="6" data-parsley-maxlength="12" data-parsley-pattern="^[a-zA-Z]+$" required />
                            </div>

                            <div class="form-group">
                                <label>Enter Your Role</label>
                                <input type="text" name="role" id="role" class="form-control" data-parsley-pattern="/^[a-zA-Z\s]+$/" required />
                            </div>
                            <div class="form-group">
                                <label>Enter Your Desired Hospital</label>
                                <input type="text" name="hospital" id="hospital" class="form-control" data-parsley-pattern="/^[a-zA-Z\s]+$/" required />
                            </div>
