                ...
                $result = mysqli_query($conn, "SELECT orderwoo.firstname,orderwoo.lastname,orderwoo.order_id,orderwoo.status,appointwoo.appoint_id,appointwoo.start_appoint FROM orderwoo INNER JOIN appointwoo ON orderwoo.order_id = appointwoo.order_id ORDER BY orderwoo.order_id DESC");
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                <?php foreach ($user as $row){
                                  if (date("d-m-Y",$row['start_appoint']) > date("d-m-Y")){ ?>
                                    <tr>
                                        <td>
                                            <?php echo $i;?>
                                        </td>
