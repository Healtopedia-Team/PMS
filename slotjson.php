...
curl_setopt_array($curl11, [
  CURLOPT_URL => "https://my.healtopedia.com/wp-json/wc-appointments/v1/appointments/?per_page=100&page=11",
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => "",
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 30,
...
curl_setopt_array($curl12, [
  CURLOPT_URL => "https://my.healtopedia.com/wp-json/wc-appointments/v1/appointments/?per_page=100&page=12",
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => "",
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 30,
...
curl_setopt_array($curl13, [
  CURLOPT_URL => "https://my.healtopedia.com/wp-json/wc-appointments/v1/appointments/?per_page=100&page=13",
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => "",
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 30,
...
curl_setopt_array($curl14, [
  CURLOPT_URL => "https://my.healtopedia.com/wp-json/wc-appointments/v1/appointments/?per_page=100&page=14",
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => "",
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 30,
...
curl_setopt_array($curl15, [
  CURLOPT_URL => "https://my.healtopedia.com/wp-json/wc-appointments/v1/appointments/?per_page=100&page=15",
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => "",
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 30,
