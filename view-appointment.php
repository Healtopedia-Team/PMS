                                        ...
                                        <?php foreach ($data as $key) {
                                            for ($q = 0; $q < 1; $q++) { ?>
                                                <div class="card-body" style="margin-top: -40px;">
                                                    ...
                                                    <div class="ans"><?php echo $key['billing']['first_name'] . " ";
                                                                        echo $key['billing']['last_name'] . " - "; ?></div>
                                            ...
                                            <div class="card-content">
                                                <div class="card-body" style="margin-top: -40px;">
                                                    ...
                                                    <?php foreach ($data2 as $key2) { ?>
                                                        ...
                                                        <div class="ans"><?php date("H:i", $key2['start'] - 28800);
                                                                            ob_start();
                                                    ...
                                                    <?php if ($key['line_items'][$q]['id']) { ?>
                                                        <ul class="list-group">
                                                            ...
                                                            <li class="list-group-item">
                                                                ...
                                                                <?php if ($key['line_items'][$q]['meta_data'][0]['key'] == "Full Name") {
