                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <h6 class="font-extrabold mb-0">
                                                    <?php
                                                    $which_hos=mysqli_query($conn, "SELECT hospital FROM user WHERE first_name=$_SESSION['name']");
                                                    $res1 = mysqli_query($conn, "SELECT COUNT(request_id) as 'cnt' FROM requestappoint WHERE req_status='pending' AND hosp_name=$which_hos[0]");
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <h6 class="font-extrabold mb-0">
                                                    <?php
                                                    $which_hos=mysqli_query($conn, "SELECT hospital FROM user WHERE first_name=$_SESSION['name']");
                                                    $res2 = mysqli_query($conn, "SELECT COUNT(request_id) as 'cnt' FROM requestappoint WHERE req_status='pending' AND hosp_name=$which_hos[0]");
