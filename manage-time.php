...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO xtime(timedisdate,timedisable,timeonoff,limitapp) VALUES('$date','$time','$dtime','$limit'),('$date','$time1','$dtime1','$limit1'),('$date','$time2','$dtime2','$limit2'),('$date','$time3','$dtime3','$limit4'),('$date','$time4','$dtime4','$limit4'),('$date','$time5','$dtime5','$limit5'),('$date','$time6','$dtime6','$limit6'),('$date','$time7','$dtime7','$limit7'),('$date','$time8','$dtime8','$limit8'),('$date','$time9','$dtime9','$limit9'),('$date','$time10','$dtime10','$limit10'),('$date','$time11','$dtime11','$limit11'),('$date','$time12','$dtime12','$limit12')";
                                        ...
                                        <?php foreach($user1 as $row): ?>
                                            <form method="POST">
                                                <tr>
                                                    <td><?php echo $row['timedisdate']; ?></td>
                                                    <td><?php echo $row['timedisable']; ?></td>
                                                    <td><?php echo $row['totalappoint']; ?></td>
                                                    <td><?php echo $row['limitapp']; ?></td>
                                                    <td>
                                                        <button type="submit" name="deletetime" class="btn btn-danger">
                                                            <i class="bi bi-trash"></i>
                                                            <input type="text" name="deletetime" value="<?php echo $row['timedisdate']; ?>" style="display: none;">
